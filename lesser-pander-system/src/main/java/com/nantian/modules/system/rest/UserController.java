...
import com.nantian.modules.system.service.dto.UserQueryCriteria;
...
import com.nantian.modules.system.service.DataService;
import com.nantian.modules.system.domain.User;
import com.nantian.exception.BadRequestException;
import com.nantian.modules.system.domain.vo.UserPassVo;
import com.nantian.modules.system.service.DeptService;
import com.nantian.modules.system.service.RoleService;
import com.nantian.modules.system.service.VerifyService;
import com.nantian.modules.system.service.UserService;
import com.nantian.utils.enums.CodeEnum;
...
public class UserController {
    ...
    public ResponseEntity<Object> delete(@RequestBody Set<Long> ids){
        for (Long id : ids) {
            Integer currentLevel =  Collections.min(roleService.findByUsersId(SecurityUtil.getCurrentUserId()).stream().map(RoleSmallDto::getLevel).collect(Collectors.toList()));
